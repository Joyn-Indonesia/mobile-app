...
import com.joyn.me.model.Chat;

import java.util.ArrayList;

import static com.joyn.me.config.ChatConfig.CHAT_ME;
...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ViewHolder> {
    ...
    public class FromMeViewHolder extends ViewHolder {
        ...
        public FromMeViewHolder(View v) {
            super(v);
            this.isiChat = (TextView) v.findViewById(com.joyn.me.R.id.isiChat);
            this.waktuChat = (TextView) v.findViewById(com.joyn.me.R.id.timeChat);
            this.image = (ImageView) v.findViewById(com.joyn.me.R.id.imageUser);
            this.status = (ImageView) v.findViewById(com.joyn.me.R.id.statusChat);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        if (viewType == CHAT_ME) {
            v = LayoutInflater.from(viewGroup.getContext())
                    .inflate(com.joyn.me.R.layout.list_chat_me, viewGroup, false);

            return new FromMeViewHolder(v);

        } else {
            v = LayoutInflater.from(viewGroup.getContext())
                    .inflate(com.joyn.me.R.layout.list_chat_you, viewGroup, false);
    ...
    private int statusAdapter(int status) {
        if (status == 0) {
            return com.joyn.me.R.drawable.ic_status_sent;
        } else {
            return com.joyn.me.R.drawable.ic_status_delivered;
        }
    }

    private void imageAdapter(ImageView image, String name) {
        TextDrawable drawable1 = TextDrawable.builder()
                .buildRound(name.substring(0, 1).toUpperCase(), com.joyn.me.R.color.brown);
