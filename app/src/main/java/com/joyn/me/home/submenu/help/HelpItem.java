...
public class HelpItem extends AbstractItem<HelpItem, HelpItem.ViewHolder> {
    ...
    @Override
    public int getType() {
        return com.joyn.me.R.id.itemHelp_id;
    }

    @Override
    public int getLayoutRes() {
        return com.joyn.me.R.layout.item_help;
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(com.joyn.me.R.id.itemHelp_icon)
        ImageView iconView;

        @BindView(com.joyn.me.R.id.itemHelp_title)
        TextView titleView;
