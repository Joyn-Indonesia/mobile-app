...
public class UpdateProfileActivity extends DialogActivity {
    @BindView(com.joyn.me.R.id.first_name)
    EditText firstName;
    @BindView(com.joyn.me.R.id.btn_home)
    ImageView backButton;
    @BindView(com.joyn.me.R.id.last_name)
    EditText lastName;
    @BindView(com.joyn.me.R.id.email)
    EditText email;
    @BindView(com.joyn.me.R.id.phone)
    EditText phone;
    @BindView(com.joyn.me.R.id.save_profile)
    Button saveProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.joyn.me.R.layout.activity_update_profile);
