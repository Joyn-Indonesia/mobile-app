...
public class PickLocation extends AppCompatActivity implements
    ...
    @BindView(com.joyn.me.R.id.mbox_picklocation)
    Button pickLocation;

    @BindView(com.joyn.me.R.id.mbox_location)
...
//            new LatLng(-34.041458, 150.790100), new LatLng(-33.682247, 151.383362));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.joyn.me.R.layout.activity_picklocation);
        ButterKnife.bind(this);

        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(com.joyn.me.R.id.map_picklocation);
                    ...
                    PickLocation.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (!addresses.isEmpty()) {
                                ...
                                addresstext.setText(com.joyn.me.R.string.text_addressNotAvailable);
                            }
                        }
                    });
                } catch (IOException e) {
