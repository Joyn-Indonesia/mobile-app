...
public class SlideRestoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.joyn.me.R.layout.fragment_slide, container, false);
        ImageView imageView = (ImageView) view.findViewById(com.joyn.me.R.id.slide_image);
...
//        Picasso.with(getContext()).load(image).into(imageView);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Realm realm = GoridemeAplication.getInstance(context).getRealmInstance();
                User loginUser = realm.copyFromRealm(GoridemeAplication.getInstance(context).getLoginUser());
