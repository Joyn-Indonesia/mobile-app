...
public class MassagePreferenceFragment extends Fragment {
    ...
    @BindView(com.joyn.me.R.id.massagePreference_image)
    ImageView massagePicture;

    @BindView(com.joyn.me.R.id.massagePreference_massageService)
    TextView massageDesc;

    @BindView(com.joyn.me.R.id.massagePreference_yourGenderGroup)
    RadioGroup yourGenderGroup;

    @BindView(com.joyn.me.R.id.massagePreference_durationGroup)
    RadioGroup durationGroup;

    @BindView(com.joyn.me.R.id.massagePreference_therapistGroup)
    RadioGroup therapistGroup;

    @BindView(com.joyn.me.R.id.massagePreference_next)
    Button nextButton;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(com.joyn.me.R.layout.fragment_massage_preference, container, false);
    }
...
//        Picasso.with(getContext()).load(massageItem.getFoto()).fit().centerCrop().into(massagePicture);
        ...
        yourGenderGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int id) {
                switch (id) {
                    case com.joyn.me.R.id.massagePreference_yourGenderMale:
                        preference.setIdGender(2);
                        preference.setGender("Male");
                        break;
                    case com.joyn.me.R.id.massagePreference_yourGenderFemale:
        ...
        durationGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int id) {
                switch (id) {
                    case com.joyn.me.R.id.massagePreference_duration60:
                        preference.setDurasi(1);
                        preference.setDurasiText("60 minutes");
                        break;
                    case com.joyn.me.R.id.massagePreference_duration90:
                        preference.setDurasi(1.5);
                        preference.setDurasiText("90 minutes");
                        break;
                    case com.joyn.me.R.id.massagePreference_duration120:
        ...
        therapistGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int id) {
                switch (id) {
                    case com.joyn.me.R.id.massagePreference_therapistMale:
                        preference.setIdTherapist(2);
                        preference.setTherapist("Male");
                        break;
                    case com.joyn.me.R.id.massagePreference_therapistFemale:
                        preference.setIdTherapist(1);
                        preference.setTherapist("Female");
                        break;
                    case com.joyn.me.R.id.massagePreference_therapistNoPrefs:
