...
public class MenuMassageFragment extends Fragment {
    ...
    @BindView(com.joyn.me.R.id.menuMassage_recycler)
    RecyclerView recycler;

    @BindView(com.joyn.me.R.id.menuMassage_text)
    TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(com.joyn.me.R.layout.fragment_menu_massage, container, false);
    }
