...
//        Picasso.with(holder.imageView.getContext()).load(getFoto()).fit().centerCrop().into(holder.imageView);
    ...
    @Override
    public int getType() {
        return com.joyn.me.R.id.itemMassageMenu_item;
    }

    @Override
    public int getLayoutRes() {
        return com.joyn.me.R.layout.item_massage_menu;
    }

    static class ViewHolder extends RecyclerView.ViewHolder {

        @BindView(com.joyn.me.R.id.itemMassageMenu_image)
        ImageView imageView;

        @BindView(com.joyn.me.R.id.itemMassageMenu_text)
        TextView textView;
