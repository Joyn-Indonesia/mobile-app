...
import static com.joyn.me.config.General.BOUNDS;
...
public class RideCarActivity extends AppCompatActivity
    ...
    @BindView(com.joyn.me.R.id.rideCar_pickUpContainer)
    LinearLayout setPickUpContainer;
    @BindView(com.joyn.me.R.id.rideCar_destinationContainer)
    LinearLayout setDestinationContainer;
    @BindView(com.joyn.me.R.id.rideCar_selector)
    RadioGroup rideCarSelector;
    @BindView(com.joyn.me.R.id.rideCar_pickUpButton)
    Button setPickUpButton;
    @BindView(com.joyn.me.R.id.rideCar_destinationButton)
    ...
    @BindView(com.joyn.me.R.id.rideCar_detail)
    LinearLayout detail;
    @BindView(com.joyn.me.R.id.rideCar_distance)
    TextView distanceText;
    @BindView(com.joyn.me.R.id.container_price)
    RelativeLayout containerPrice;
    @BindView(com.joyn.me.R.id.rideCar_price)
    TextView priceText;
    @BindView(com.joyn.me.R.id.rideCar_paymentGroup)
    RadioGroup paymentGroup;
    @BindView(com.joyn.me.R.id.rideCar_mPayPayment)
    RadioButton mPayButton;
    @BindView(com.joyn.me.R.id.rideCar_cashPayment)
    RadioButton cashButton;
    @BindView(com.joyn.me.R.id.rideCar_topUp)
    Button topUpButton;
    @BindView(com.joyn.me.R.id.rideCar_order)
    Button orderButton;
    @BindView(com.joyn.me.R.id.rideCar_mPayBalance)
    TextView mPayBalanceText;
    @BindView(com.joyn.me.R.id.rideCar_select_car_container)
    RadioButton carSelectContainer;
    @BindView(com.joyn.me.R.id.rideCar_select_ride_container)
    RadioButton rideSelectContainer;
...
//            new LatLng(8.015870, 142.285892)); // northeast
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.joyn.me.R.layout.activity_ride_car);
...
//        diskonMpay = GoridemeAplication.getInstance(this).getDiskonMpay();
        ...
        discountText.setText("Discount " + designedFitur.getDiskon() + " with Wallet");
        ...
        paymentGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (paymentGroup.getCheckedRadioButtonId()) {
                    case com.joyn.me.R.id.rideCar_mPayPayment:
                        ...
                        break;
                    case com.joyn.me.R.id.rideCar_cashPayment:
                        biayaTotal = harga;
...
//                onDestinationClick();
    ...
    private LatLng getLocationFromAddress(String strAddress) {
        ...
        strAddress = "Makassar, Sulawesi Selatan, Indonesia";
        Log.e("LOCATION", strAddress);
...
//            return p1;
    ...
    private void selectCar() {
        carSelectContainer.setChecked(true);
        carSelectContainer.setChecked(true);
        rideSelectContainer.setChecked(false);
        rideSelectContainer.setChecked(false);
...
//        minPrice = designedFitur.getBiaya_minimum();
    ...
    private void selectRide() {
        carSelectContainer.setChecked(false);
        carSelectContainer.setChecked(false);
        rideSelectContainer.setChecked(true);
        rideSelectContainer.setChecked(true);
...
//        minPrice = designedFitur.getBiaya_minimum();
    ...
    private void updateFitur() {
        ...
        if (designedFitur.getIdFitur() == 1) {
            title.setText(com.joyn.me.R.string.home_mRide);
        } else if (designedFitur.getIdFitur() == 2) {
            title.setText(com.joyn.me.R.string.home_mCar);
        }
            ...
            for (Driver driver : driverAvailable) {
                ...
                if (designedFitur.getIdFitur() == 1) {
                    ...
                    driverMarkers.add(
                            gMap.addMarker(new MarkerOptions()
                                    .position(currentDriverPos)
                                    .icon(BitmapDescriptorFactory.fromResource(com.joyn.me.R.drawable.ic_m_car_pin)))
                    );
                }
            }
        }
                    ...
                    RideCarActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (!addresses.isEmpty()) {
                                ...
                                editText.setText(com.joyn.me.R.string.text_addressNotAvailable);
                            }
                        }
                    });
                } catch (IOException e) {
        ...
        try {
            ...
            if (routes.size() > 0) {
                directionLine = gMap.addPolyline((new PolylineOptions())
                        ...
                        .color(ContextCompat.getColor(RideCarActivity.this, com.joyn.me.R.color.directionLine))
                        .width(5));
    ...
    private void updateDistance(long distance) {
        ...
        rideCarSelector.setVisibility(View.GONE);
