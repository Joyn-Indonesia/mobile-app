...
import static com.joyn.me.utils.Utility.round;
...
public class SendActivity extends AppCompatActivity implements
    ...
    @BindView(com.joyn.me.R.id.mSend_title)
    TextView title;
    @BindView(com.joyn.me.R.id.btn_home)
    ImageView backButton;
    @BindView(com.joyn.me.R.id.mSend_pickUpContainer)
    LinearLayout setPickUpContainer;
    @BindView(com.joyn.me.R.id.mSend_destinationContainer)
    LinearLayout setDestinationContainer;
    @BindView(com.joyn.me.R.id.mSend_pickUpButton)
    Button setPickUpButton;
    @BindView(com.joyn.me.R.id.mSend_destinationButton)
    Button setDestinationButton;
    @BindView(com.joyn.me.R.id.mSend_pickUpText)
    AutoCompleteTextView pickUpText;
    @BindView(com.joyn.me.R.id.mSend_destinationText)
    AutoCompleteTextView destinationText;
    @BindView(com.joyn.me.R.id.mSend_detail)
    LinearLayout detail;
...
//    Button topUpButton;
    @BindView(com.joyn.me.R.id.mSend_next)
    Button nextButton;
...
//            new LatLng(-34.041458, 150.790100), new LatLng(-33.682247, 151.383362));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.joyn.me.R.layout.activity_send);
        ...
        mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(com.joyn.me.R.id.mSend_mapView);
        ...
        try {
            ...
            if (routes.size() > 0) {
                directionLine = gMap.addPolyline((new PolylineOptions())
                        ...
                        .color(ContextCompat.getColor(SendActivity.this, com.joyn.me.R.color.directionLine))
                        .width(5));
