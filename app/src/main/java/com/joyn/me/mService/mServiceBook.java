...
public class mServiceBook extends AppCompatActivity
    ...
    @BindView(com.joyn.me.R.id.mService_location)
    AutoCompleteTextView setLocation;

    @BindView(com.joyn.me.R.id.mService_locbtn)
    Button setLocButton;

    @BindView(com.joyn.me.R.id.service_paymentgroup)
    RadioGroup paymentGroup;

    @BindView(com.joyn.me.R.id.service_cash)
    RadioButton serviceCash;

    @BindView(com.joyn.me.R.id.service_mpay)
    RadioButton serviceMpay;

    @BindView(com.joyn.me.R.id.mpay_balance)
    TextView textMpay;

    @BindView(com.joyn.me.R.id.service_pricetag)
    TextView textPrice;

    @BindView(com.joyn.me.R.id.service_topup)
    Button topupButton;
...
//            new LatLng(-34.041458, 150.790100), new LatLng(-33.682247, 151.383362));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.joyn.me.R.layout.activity_mservice_book);
        ...
        discountText.setText("Discount " + selectedFitur.getDiskon() + " with Wallet");

        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(com.joyn.me.R.id.mService_map);
        ...
        paymentGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                switch (paymentGroup.getCheckedRadioButtonId()) {
                    case com.joyn.me.R.id.service_mpay:
                        pakaiMpay = 1;
                        ...
                        break;
                    case com.joyn.me.R.id.service_cash:
                        pakaiMpay = 0;
                        biayaTotal = harga;
    ...
    private void onSetLocationClick() {
        ...
        orderButton.setBackgroundResource(com.joyn.me.R.color.colorPrimary);
    }
            ...
            for (Driver driver : driverAvailable) {
                ...
                driverMarkers.add(
                        gMap.addMarker(new MarkerOptions()
                                ...
                                .icon(BitmapDescriptorFactory.fromResource(com.joyn.me.R.drawable.ic_service_pin)))
                );
            }
        }
    }
    ...
    private void onOrderButtonClick() {
        if (driverAvailable.isEmpty()) {
            AlertDialog dialog = new AlertDialog.Builder(mServiceBook.this)
                    .setMessage("Sorry, there are no technicians available")
